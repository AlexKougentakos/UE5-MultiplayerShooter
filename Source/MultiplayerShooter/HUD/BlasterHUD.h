...
public:
	...
	UPROPERTY(EditAnywhere, Category = "UI", DisplayName = "Warmup Announcement Class")
	TSubclassOf<UUserWidget> m_pWarmupAnnouncementClass{};
	
	UAnnouncement* m_pWarmupAnnouncement{};
